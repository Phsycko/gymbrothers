...
export function MemberHeader({ user }: MemberHeaderProps): React.ReactElement {
	return (
		<header className="sticky top-0 z-30 flex h-14 items-center justify-between border-b border-white/10 bg-black/80 px-4 pt-safe backdrop-blur-md sm:px-5 md:h-16 md:px-6">
