...
import { MemberUsernameForm } from "@/features/member-portal/components/member-username-form";
			...
			<div className="rounded-2xl border border-white/10 bg-white/5 p-5 backdrop-blur-xl">
				...
				{portal.plan && portal.subscription ? (
					<dl className="mt-4 space-y-3 text-sm">
						...
						<div>
							...
							<dd className="font-medium text-white">
								...
								{formatPlanDurationLabel(portal.plan)}
							</dd>
						</div>
						<div>
					...
					<p className="mt-3 text-sm text-white/55">
						No hay un plan activo registrado. Contacta recepción para más
						información.
					</p>
				)}
			</div>
