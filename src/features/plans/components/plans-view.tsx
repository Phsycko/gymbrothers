			...
			<div className="flex flex-col gap-4 sm:flex-row sm:items-start sm:justify-between">
				<div>
					...
					<p className="mt-1 max-w-2xl text-sm text-slate-500">
						Define precios en centavos, edita o elimina planes desde cada
						tarjeta, y controla la visibilidad con Activo / Inactivo. Solo se
						pueden eliminar planes sin suscripciones vinculadas.
					</p>
				</div>
